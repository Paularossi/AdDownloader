...
def assess_image_quality(image_path):
    ...
    with Image.open(image_path) as img:
        ...
        # brightness - mean of the grayscale (luminance-weighted) pixel intensities.
        # computed via numpy instead of a per-pixel Python loop, which is orders of magnitude faster on large images.
